                            ...
                            exchangeItems.map((item) => (
                                <div key={item.id} className="reward-card" onClick={() => handleRewardClick(item)}>
                                    <div className="reward-image">
                                        {item.image ? (
                                            <img
                                                src={item.image.startsWith('http') ? item.image : `${import.meta.env.VITE_API_URL || "https://roadpulsebackend.onrender.com"}${item.image}`}
                                                alt={item.name}
                                            />
                                        ) : (
                        ...
                        <div className="rounded-lg bg-white p-6 shadow-lg mx-auto rewards-modal-content">
                            ...
                            {isStaff && (
                                <div className="mb-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                    <p className="text-sm text-yellow-800">
                                        ⚠️ Admin/Staff accounts cannot redeem rewards.
                                    </p>
                                </div>
                            )}
                            ...
                            <div className="rewards-modal-actions">
                                ...
                                <button
                                    ...
                                    disabled={Number(points) < selectedItem.points_cost || isStaff}
